...
public class ExcelDeal {
    public static void main(String[] args) {
       //  String arr[] = {"aaa", "xxx"};
        ...
        try (Workbook workbook = new XSSFWorkbook(new FileInputStream("E:\\www\\product\\a\\" + filename))) {
            // 获取工作簿
    ...
    public static void createExcel(String filename, List title_list, List data_list){
        try (Workbook workbook = new XSSFWorkbook();
             FileOutputStream out = new FileOutputStream("E:\\www\\product\\out\\" + filename)) {
